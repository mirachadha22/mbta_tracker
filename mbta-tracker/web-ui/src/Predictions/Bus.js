...
function BusInfo({loadingStatus, currentLocation, session, homeTab, doUpdate}) {
        ...
        <div>
          ...
          <Row>
            <div className="col" align="center">
              <iframe title="Google Maps Current Location Bus Tab"
                width="1000"
                height="400"
                style={{border:1}}
                loading="lazy"
...
export default connect(({loadingStatus, currentLocation, session, homeTab, doUpdate}) => 
  ({loadingStatus, currentLocation, session, homeTab, doUpdate}))(BusInfo);
